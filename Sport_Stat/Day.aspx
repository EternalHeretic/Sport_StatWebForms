<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Day.aspx.cs" Inherits="Sport_Stat.Day" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="FeaturedContent" runat="server">
    ...
    <div class="tableContent">
        ...
        <asp:GridView ID="Days" runat="server" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="SqlDataSource2" BorderStyle="None" BorderWidth="1px" CellPadding="4" AllowPaging="True" CssClass="ui-grid" PageSize="4" DataKeyNames="DayId">
        <Columns>
            ...
            <asp:BoundField DataField="N_day" HeaderText="Номер дня" SortExpression="N_day" />
        </Columns>
    ...
    <asp:SqlDataSource 
        ...
        SelectCommand="SELECT * FROM [Days] ORDER BY [N_day]">
